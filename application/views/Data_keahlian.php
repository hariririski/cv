			 ...
			 _________________________________________________________ -->
                    ...
                    <div class="col-md-12 clearfix" id="customer-account">
                          ...
                          <div class="box">
                            ...
                            <div class="heading">
                                <h3 class="text-uppercase">Keahlian</h3>
                            </div>
                            ...
                            <form action="<?php echo base_url()?>" method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group">
                                          <div class="col-sm-4">
                                                <label for="password_old">Nama Kelahlian</label>
                                          </div>
                                          <div class="col-sm-8">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group">
                                          <div class="col-sm-4">
                                                <label for="password_old">Presentase</label>
                                          </div>
                                          <div class="col-sm-8">
                                            <input type="password" class="form-control" id="password_old">
                                          </div>
                                ...
                                <div class="text-center">
                                    <button type="submit" class="btn btn-template-main"><i class="fa fa-save"></i>Simpan Keahlian</button>
                                </div>
                            </form>
                          </div>

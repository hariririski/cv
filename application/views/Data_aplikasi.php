			 ...
			 _________________________________________________________ -->
                    ...
                    <div class="col-md-12 clearfix" id="customer-account">
                          ...
                          <div class="box">
                            ...
                            <div class="heading">
                                <h3 class="text-uppercase">Tambah Aplikasi</h3>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group">
                                          <div class="col-sm-4">
                                                <label for="password_old">Nama Aplikasi</label>
                                          </div>
                                          <div class="col-sm-8">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group">
                                          <div class="col-sm-4">
                                                <label for="password_old">Deskripsi</label>
                                          </div>
                                          <div class="col-sm-8">
                                            <input type="password" class="form-control" id="password_old">
                                          </div>
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group">
                                          <div class="col-sm-4">
                                                <label for="password_old">Tahun Pembuatan</label>
                                          </div>
                                          <div class="col-sm-8">
                                            <input type="password" class="form-control" id="password_old">
                                          </div>
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group">
                                          <div class="col-sm-4">
                                                <label for="password_old">Bahasa Pemrograman</label>
                                          </div>
                                          <div class="col-sm-8">
                                            <input type="password" class="form-control" id="password_old">
                                          </div>
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group">
                                          <div class="col-sm-4">
                                                <label for="password_old">Link Demo</label>
                                          </div>
                                          <div class="col-sm-8">
                                            <input type="password" class="form-control" id="password_old">
                                          </div>
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><a href="customer-order.html" class="btn  btn-danger">Foto</a>
                                            </td>
                                        </tr>
